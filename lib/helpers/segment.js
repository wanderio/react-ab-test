...
exports.default = {
  enable: function enable() {
    if (_ExecutionEnvironment.canUseDOM) {
      ...
      identifySubscription = _emitter2.default.addIdentifyListener(function (experimentName, variantName) {
        analytics.identify(_defineProperty({}, experimentName, variantName), function () {
          return _emitter2.default.emit('analytics-identify', experimentName, variantName);
        });
      });
    }
  },
